...
//! The length of the buffer **MUST** be divisible by [`ALIGNMENT`].
//!
...
//! of the data without copying &ndash; they do pad the data to [`OwnedBytes::ALIGNMENT`],
...
pub trait Input: Sized {
    /// Type of the iterator used by [`iter_blocks`], parameterized
