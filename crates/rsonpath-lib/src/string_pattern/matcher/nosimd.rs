...
/// Default, non-vectorised [`StringPattern`](crate::string_pattern::StringPattern) matcher.
///
/// This is mostly exposed for testing purposes.
pub struct NosimdStringMatcher;
