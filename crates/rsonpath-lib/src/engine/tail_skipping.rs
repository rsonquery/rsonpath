...
#[multiversion::multiversion(targets("x86_64+avx2+pclmulqdq+popcnt"))]
fn skip<'i, I, V>(
    self_: &mut TailSkip<'i, I, V::QuotesClassifier<'i, I>, V::StructuralClassifier<'i, I>, V, BLOCK_SIZE>,
    opening: BracketType,
    ...
    V: Simd,
{
    ...
    self_.classifier = Some('a: {
        ...
        let mut current_vector = match first_vector {
            ...
            None => match depth_classifier.next() {
                ...
                Err(e) => {
                    ...
                    break 'a self_.simd.resume_structural_classification(resume_state);
                }
            },
        };
        ...
        self_.simd.resume_structural_classification(resume_state)
    });
