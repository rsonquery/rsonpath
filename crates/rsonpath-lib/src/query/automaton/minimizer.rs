...
mod tests {
    ...
    // TODO: I can't figure out the lifetimes to make this one work correctly
    // fn wrap_label(label_str: &str) -> TransitionLabel {
    //     let inner_label = Label::new(label_str);
    //     let wrapped_label = (&label_a).into();
    // }
}
