...
macro_rules! count_test_cases {
    ($test_name:ident, $impl:ident) => {
        ...
        #[test_case("basic/array_root.json", "" => 1; "array_root.json")]
        #[test_case("basic/array_root_nested.json", "$[0]" => 1; "array_root.json nneg array top")]
        #[test_case("basic/array_root_nested.json", "$[0].*" => 1; "array_root.json nneg array inner any child")]
        #[test_case("basic/array_root_nested.json", "$.*[0]" => 2; "array_root.json any nneg array inner")]
        #[test_case("basic/array_root_nested.json", "$[2][1][0][1]" => 1; "array_root.json any nneg array inner inner inner")]
        #[test_case("basic/array_root_nested.json", "$[2][1].*" => 3; "array_root.json any nneg array inner inner child")]
        #[test_case("basic/array_root_nested.json", "$[2].*[1]" => 1; "array_root.json nneg array desc inner")]
        #[test_case("basic/array_root_nested.json", "$[2]..*[1]" => 4; "array_root.json nneg array any desc inner")]
        #[test_case("basic/array_root_nested.json", "$[2]..*" => 11; "array_root.json nneg array any desc")]
        #[test_case("basic/array_root_nested.json", "$..*[0]" => 7; "array_root.json anydesc nneg array")]
        #[test_case("basic/array_root_nested.json", "$[2][0]" => 1; "array_root.json nneg array direct first")]
        #[test_case("basic/array_root_nested.json", "$[2][1]" => 1; "array_root.json nneg array direct second")]
...
macro_rules! indices_test_cases {
    ($test_name:ident, $impl:ident) => {
        ...
        #[test_case("basic/array_root_nested.json", "$[0]" => vec![6]; "array_root.json nneg array top")]
        #[test_case("basic/array_root_nested.json", "$[0].*" => vec![16]; "array_root.json nneg array inner any child")]
        #[test_case("basic/array_root_nested.json", "$.*[0]" => vec![16,49]; "array_root.json any nneg array inner")]
        #[test_case("basic/array_root_nested.json", "$[2][1][0][1]" => vec![95]; "array_root.json any nneg array inner inner inner")]
        #[test_case("basic/array_root_nested.json", "$[2][1].*" => vec![75, 142, 209]; "array_root.json any nneg array inner inner child")]
        #[test_case("basic/array_root_nested.json", "$[2].*[1]" => vec![142]; "array_root.json nneg array desc inner")]
        #[test_case("basic/array_root_nested.json", "$[2]..*[1]" => vec![95, 142, 162, 229]; "array_root.json nneg array any desc inner")]
        #[test_case("basic/array_root_nested.json", "$[2]..*" => vec![49, 61, 75, 93, 95, 142, 160, 162, 209, 227, 229]; "array_root.json nneg array any desc")]
        #[test_case("basic/array_root_nested.json", "$..*[0]" => vec![16,17,49,75,93,160,227]; "array_root.json anydesc nneg array")]
        #[test_case("basic/array_root_nested.json", "$[2][0]" => vec![49]; "array_root.json nneg array direct first")]
        #[test_case("basic/array_root_nested.json", "$[2][1]" => vec![61]; "array_root.json nneg array direct second")]
