...
macro_rules! count_test_cases {
    ($test_name:ident, $impl:ident) => {
        ...
        #[test_case("basic/atomic_descendant.json", "$..*..b" => 1; "atomic_descendant.json $..*..b")]
        ...
        #[test_case("basic/singletons_and_empties.json", r#"$..*.*"# => 2; "singletons_and_empties.json anydescendant $..*.*")]
        ...
        #[test_case("basic/wildcard_list2.json", r#"$..a..*..b..*"# => 9; "wildcard_list2.json anydescendant $..a..*..b..*")]
...
macro_rules! indices_test_cases {
    ($test_name:ident, $impl:ident) => {
        ...
        #[test_case("basic/singletons_and_empties.json", r#"$..*..*"# => vec![21, 50]; "singletons_and_empties.json anydescendant")]
        ...
        #[test_case("basic/wildcard_list2.json", r#"$..a..*..b..*"# => vec![226, 364, 402, 479, 519, 559, 601, 641, 881]; "wildcard_list2.json anydescendant $..a..*..b..*")]
        ...
        #[test_case("basic/wildcard_object2.json", r#"$..a..*..*..b..*..*"# => vec![652, 709, 751, 791, 855, 901, 945, 1016, 1067, 1115, 1193, 1248, 1300, 1385, 1443, 1499, 1590, 1653, 1713, 1811, 1878, 1942, 2048]; "wildcard_object2.json anydescendant $..a..*..*..b..*..*")]
        #[test_case(
        ...
        #[test_case("basic/compressed/child.json", "$..*..b.c..*" => vec![99, 128, 132, 152]; "compressed child.json anydescendant $..*..b.c..*")]
