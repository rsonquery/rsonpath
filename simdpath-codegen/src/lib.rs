...
//! - `simdpath::stackless::automata` generated from [`stackless::automata`]
//! - `simdpath::bytes::sequences` generated from [`bytes::sequences`]
//!
//! ## Note
//!
//! The intra links to the main `simdpath` crate are broken until we find a way
...
pub fn calculate_codegen_md5() -> md5::Digest {
    ...
    let stackless_automata = include_str!("stackless/automata.rs");
    let stackless_mod = include_str!("stackless/mod.rs");

    let contents = format!(
        "{}{}{}{}{}",
        bytes_mod, bytes_sequences, lib, stackless_automata, stackless_mod
    );
