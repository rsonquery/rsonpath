...
macro_rules! count_test_cases {
    ($test_name:ident, $impl:ident) => {
        ...
        #[test_case("basic/twitter.json", "$.search_metadata.count" => 1; "twitter.json $.search_metadata.count (child-child)")]
        #[test_case("basic/twitter.json", "$..search_metadata.count" => 1; "twitter.json $..search_metadata.count (recursive-child)")]
        #[test_case("basic/twitter.json", "$.search_metadata..count" => 1; "twitter.json $.search_metadata..count (child-recursive)")]
        #[test_case("basic/twitter.json", "$..search_metadata..count" => 1; "twitter.json $..search_metadata..count (recursive-recursive)")]
        #[test_case("basic/twitter.json", "$..count" => 1; "twitter.json $..count")]
